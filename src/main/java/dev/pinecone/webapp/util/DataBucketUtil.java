package dev.pinecone.webapp.util;
...
public class DataBucketUtil {
    ...
    public InputFileDto uploadFile(MultipartFile multipartFile, String fileName, String contentType) {
        ...
        try{
            ...
            if(blob != null){
                ...
                return new InputFileDto(fileName, blob.getMediaLink());
            }
    ...
    private File convertFile(MultipartFile file) {
        ...
        try{
            ...
            throw new GenericException(ErrorEnum.FILE_WRONG_FORMAT);
        }
    }
